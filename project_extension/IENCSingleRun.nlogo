...
to go
  if (check-end = true) [
    ...
    type "Percent non compliance at end: " show percent-non-comply
    type "Institution action: " show InstitutionAction
    type "Institution condition: " show InstitutionCondition
    stop
...
;  ]
  ...
  set non-compliance (((count comps with [compliance = 1])/ NumberOfAgents) * 100)
  rewire-links
  tick
end
...
"" ""
PENS
"default" 1.0 0 -16777216 true "" "plotxy ticks non-compliance"
