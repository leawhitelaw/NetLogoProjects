...
** This model does not give agents the opportunity to establish an institution **

Each agent in the model is initialised randomly with a strategy to consume the resource and links to their two closest neighbours. If an agent is unhappy with it's energy, it can copy the strategy of it's neighbour. 
...
An extension of this model would include the establishment of an institution, agent non-compliance and sanctioning of non-compliant agents.
